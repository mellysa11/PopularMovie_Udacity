...
/*
*@brief: The main UI for the MovieDetailActivity and handles the logic for the view
...
public class MovieDetailFragment extends Fragment {
    ...
    /*
    * @brief: private globals for the class
    * */
    ...
    * */
    ...
    /*
    * @brief: set up of all the main logic
    * It is to decide how to display the details fragment
    * */
    @Override
    ...
    /**
     * @brief: extends the menu options to add share functionality
     * whenever details fragment is used
     * @param menu
     * @param inflater
     */
    @Override
    ...
    /**
     * @brief TO display the share intent
     * @return
     */
    ...
    /**
     * @brief : Adds the favourite movies into the DB
     */
    ...
    /**
     * @brief : Deletes non favourite movies from DB
     */
    ...
    /**
     * @brief: Quey the DB to see if the movie is already present in DB
     * @return
     */
    private boolean checkFavorites() {
     ...
     /**
     * @brief: Helper function to display all the movie details
     */
    ...
    /**
     * @brief: Toggles the favoutite state of the movie depending if its already there in the DB
     */
    ...
    /**
     * @brief : Parses the saved json movie review
     */
    ...
    /**
     * @brief: Parse the saved json movie trailor
     */
